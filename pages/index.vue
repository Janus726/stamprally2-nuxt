<template>
  <div id="app" style="background-color: #fafafa; padding-bottom: 120px">
    <b-container fluid>
      <b-row>
        <b-col class="d-flex">
          <div>
        ...
        <b-col>
          ...
          <b-card class="my-3 shadow-sm align-items-center" style="border: none; border-radius: 8px">
            <div class="d-flex text-center mt-3">
              <h5>2021</h5><p>&nbsp;年&nbsp;</p><h5>11</h5><p>&nbsp;月&nbsp;</p><h5>1</h5><p>&nbsp;日&nbsp;</p>
              <h5>&nbsp;~&nbsp;</h5><h5>2022</h5><p>&nbsp;年&nbsp;</p><h5>1</h5><p>&nbsp;月&nbsp;</p><h5>31</h5><p>&nbsp;日&nbsp;</p>
            </div>
          </b-card>
        </b-col>
      </b-row>
      ...
      <b-row class="m-auto fixed-bottom">
        <b-col class="d-flex justify-content-center mb-4">
          <b-button v-b-modal.settings pill class="btn-hover color-1 mb-4">
            はじめる
          </b-button>
...
<!--            終了しました-->
<!--          </b-button>-->
          <b-modal id="enterName" centered hide-header hide-footer>
            ...
            <div v-else class="my-2 d-block text-center">
              <div v-if="formNum === 1">
                ...
                <b-form class="form-inline justify-content-center mt-3">
                  <div class="col-8">
                    <b-form-input
                      ...
                      @submit.prevent
                    />
                    <b-button variant="primary" size="lg" block class="mt-3" @click="nextForm()">
                      確定
                    </b-button>
                  </div>
                </b-form>
              ...
              <div v-else-if="formNum === 2">
                ...
                <b-form class="form-inline justify-content-center mt-3">
                  <div class="col-8">
                    <b-dropdown :text="age" variant="outline-secondary" size="lg">
                      <b-dropdown-item
                        @click="age = '10代'"
                      >
                        10代
              ...
              <div v-else-if="formNum === 3">
                ...
                <b-form class="form-inline justify-content-center mt-3">
                  <div class="col-8">
                    <b-dropdown :text="region" variant="outline-secondary" size="lg">
                      <b-dropdown-item
                        @click="region = '佐賀市'"
                      >
                        佐賀市
...
export default {
  ...
  //   const _this = this
  //   // eslint-disable-next-line no-console
  //   console.log(',' + this.$store.state.isRegister, this.$store.state.clientId)
  ...
  methods: {
    ...
    checkTime () {
      const open = new Date(2021, 10, 1) // １１月１日
      const close = new Date(2022, 1, 1) // １月３１日
    ...
    addUser () {
      ...
      this.db
        ...
        .doc(this.clientId).set({
          ...
          name: this.userName(this.inputName),
          team: '',
          ...
          this.db
            ...
            .set({
              ...
              // eslint-disable-next-line no-console
              console.log('success')
              this.$store.dispatch('setClientId', this.clientId)
              this.$store.dispatch('setUserName', this.userName(this.inputName))
              this.$store.dispatch('setTeam', '')
              this.$store.dispatch('setUserColor', this.userColor)
              this.$store.dispatch('setTeamStatus', this.teamStatus)
              this.isRegistered = 1
              this.$store.dispatch('setRegister', this.isRegistered)
